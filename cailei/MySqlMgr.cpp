...
bool TestInsert()
{
	...
	const sql::SQLString g_sInsert = "INSERT INTO test (ordernum, remark, cancell,name,timestamp,intime) VALUES('yykdjkd', '裤袜*1 衣服*2', 0,'蔡lei','2018-09-13 21:15:10','2018-09-13')";
